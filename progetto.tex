...
[a4paper,bindingoffset=0.2in,%
 left=1.55in,right=1.55in,top=2in,bottom=2in,%
 footskip=.25in]
...
\begin{tabular}{|c|c|c|}
	\hline
	\textbf{Partecipanti} & B2C & \\ \hline
	\textbf{Oggetti} & Servizi & \\ \hline
	\textbf{Orizzonte Temporale} & Semi Dinamico & \\ \hline
	\textbf{Driver} & Migliorare l'organizzazione &  \\ \hline
\end{tabular}
